...
class ProjectItem extends Component {
  ...
  addTask() {
    axios
      .post(
        `http://localhost:8080/api/projects/assign/${this.props.match.params.id}`,
    ...
    const data = this.state.tasks.filter((e) => {
      try {
        if (this.state.search === "") return e;
          ...
          e.taskName.toLowerCase().includes(this.state.search.toLowerCase()) ||
          e.status.toLowerCase().includes(this.state.search.toLowerCase())
        ) {
          return e;
        }
      } catch (error) {
      ...
      <div className="container-fluid mt-2" style={{ width: "75%" }}>
        ...
        >
          <Card.Body>
            <Container>
              <Row>
                <Col style={{ borderLeft: "2px solid #eb5d1e" }}>
                  <Card.Title>
                    <h1 style={{ color: "#4e4039" }}>
                      {this.state.projectTitle}
                    </h1>
                  </Card.Title>
                  <Card.Text className="text-uppercase">
                    {this.state.completeTasks === this.state.tasks.length ? (
                  ...
                  <Link
                    ...
                    to={`/projects/${this.props.match.params.id}/taskbord`}
                ...
                <Col>
                  ...
                  <div>
                    <h5 className="container-fluid d-flex justify-content-end mt-2 ">
                      ...
                      >
                        Number of tasks: {this.state.completeTasks}/
            ...
            <>
              <Modal
                show={this.state.newTaskModal}
                onHide={this.toggleNewTaskModal.bind(this)}
